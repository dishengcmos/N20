...
uint8_t Version[16]={CHAR_V,0,CHAR_POINT,2,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON,CHAR_NON};
//版本号为v0.1																																				 			
/***********************校准 for 工厂****************************/	
...
{ 
	...
	i_cur++;
	sum_cur += Current_ldoub_tmp;
	if(i_cur>=5)//14
	{
		output_tmp1=sum_cur/5;//14
		i_cur=0;
		sum_cur=0;
...
//	static long double output_tmp;
////	static uint8_t i_cur=0;
////	i_cur++;
////	sum_cur += Current_ldoub_tmp;
////	if(i_cur>=14)
////	{
////		output_tmp=sum_cur/14;
////		i_cur=0;				
////		sum_cur=0;				
//	output_tmp= GetDisplayCurrent(); 
//	if((output_tmp>20)||(output_tmp<-20)) 
//		Current_ldoub=output_tmp; 
//	else
//		Current_ldoub=0;
